...
export async function homeAboutUsList() {
    try {
        const res = await fetch("https://api.abajstore.ir/home/about-us/", {
            ...defaultFetchOptions,
...
export async function homeContactInfoList() {
    try {
        const res = await fetch("https://api.abajstore.ir/home/contact-info/", {
            ...defaultFetchOptions,
            next: { revalidate: 3600 }
        });
        if (!res.ok) return [];
...
export async function homeGalleryList() {
    try {
        const res = await fetch("https://api.abajstore.ir/home/gallery/", {
            ...defaultFetchOptions,
            next: { revalidate: 3600 }
        });
...
export async function homeSliderList() {
    try {
        const res = await fetch("https://api.abajstore.ir/home/sliders/", {
            ...defaultFetchOptions,
