              ...
              <SwiperSlide key={offer.id}>
                <div className="flex flex-col items-center justify-between h-full w-full px-3 pt-2 pb-4">
                  ...
                  <div className="w-full text-center mb-1 overflow-hidden">
                    <Link 
                      href={offer.link} 
                      className="text-sm font-bold text-gray-800 line-clamp-2 hover:text-orange-500 transition-colors h-10 leading-5 block"
                    >
                      {offer.title}
                    </Link>
                  </div>
                  ...
                  <div className="flex justify-between items-center w-full px-1 shrink-0 mt-auto">
                     <button className="text-orange-500 bg-primary/10 p-2 rounded-lg hover:bg-orange-500 hover:text-white transition-all">
                    ...
                    <div className="text-left">
                      {/* تغییر رنگ قیمت به نارنجی (text-orange-500) */}
                      <p className="text-orange-500 font-bold text-base">{offer.price} <small className="text-xs text-gray-500">تومان</small></p>
                    </div>
                  </div>
                </div>
              </SwiperSlide>
